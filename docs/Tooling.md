...
|-------|------|------------|--------|
| **Cheap / default** | Most code changes | `uv run pytest` | Offline; no API key |
...
- Do not invent extra required tools. Live-key smokes stay optional and Human-TODO / env-gated.
