...
- First public version was **`0.1.0a1`**. Consumer-facing README/summary updates that should reach PyPI go out as the next pre-release (**`0.1.0a3`**, then `a4`…). Classifier stays **Alpha**.
