...
| 2026-09-23 | `grok-4.7` stays in the no-batch family | Model detail page: Batch API not supported. Public model blob omits `batchEnabled` (same as 4.6/4.5; 4.3 sets it true). `need=batch` remaps to `grok-4.3`. Cite: https://docs.x.ai/developers/models/grok-4.7 |
...
- **Last reconciled with code**: 2026-09-23 (`grok-4.7` stays off `need=batch`)
