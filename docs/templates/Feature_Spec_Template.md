...
**Humans:** This is the contract. How to read it: [`help/SCAFFOLDS.md`](help/SCAFFOLDS.md) · [`help/USAGE.md`](help/USAGE.md).

**Agents:** Fill-in blanks — not a tutorial. If context is thin, re-open [`agent/workflow/understanding.md`](agent/workflow/understanding.md) §2. Catalog: [`agent/workflow/extensions.md`](agent/workflow/extensions.md) §7.1. Decisions: [`agent/workflow/decisions.md`](agent/workflow/decisions.md). Operable Acceptance: [`agent/workflow/todos.md`](agent/workflow/todos.md) §5.3. Ship-first (no Understanding): [`agent/workflow/profile-standing.md`](agent/workflow/profile-standing.md) §0.1.
