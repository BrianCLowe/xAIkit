...
| [Team-Roster.md](Team-Roster.md) | Optional — who can take follow-ups when `team_inbox` is on (named humans and bots). Do not invent teammates ([`Team_Roster_Template.md`](templates/Team_Roster_Template.md)) |
